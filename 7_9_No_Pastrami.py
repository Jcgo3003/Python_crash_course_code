...
# he sandwich 'pastrami' appears in the list at least three times. Add code near 
...
sandwich_orders = ["pastrami" , "Club", "French", "pastrami","Cheese", "Doble Chesse", "pastrami"]

print("Sorry all the pastrami is out")
