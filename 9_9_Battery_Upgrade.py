...
# lready. Make an electric car with a default battery size, call get_range() 
...
coche_electrico = ElectricCar("Rotten Apple", "XL", "2025")

coche_electrico.battery.describe_battery()
coche_electrico.battery.get_range()
coche_electrico.battery.upgrade_battery()
coche_electrico.battery.describe_battery()
coche_electrico.battery.get_range()
